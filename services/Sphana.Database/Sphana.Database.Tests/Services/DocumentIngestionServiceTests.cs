...
/// Note: Full integration tests with ONNX models are in DocumentIngestionServiceIntegrationTests
/// </summary>
public class DocumentIngestionServiceTests
{
    [Fact]
    public void DocumentIngestionService_Should_Be_Instantiable_With_Mocks()
    {
