...
from sphana_text_facade.controllers.documents.v1 import router as document_management_controller_router
...
def main(host='0.0.0.0', port=5002, max_threads=100, debug=False):
    ...
    fast_api: FastAPI = FastAPI(
        title="SphanaText Facade API",
        description="API for SphanaText Facade",
        version="1.0.0"
    )
