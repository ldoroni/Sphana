...
class TextEmbedderService:
    ...
    def __init__(self):
        ...
        # From: services/sphana-text-facade-service/src/python/sphana_text_facade/__main__.py
        # To:   services/sphana-text-facade-service/src/resources/models/embedding
