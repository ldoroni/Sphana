...
from sphana_processor.controllers.text.v1 import router as text_processor_controller_router
...
def main(host='0.0.0.0', port=5002, max_threads=100, debug=False):
    ...
    fast_api: FastAPI = FastAPI(
        title="Sphana Processor API",
        description="API for Sphana Processor",
        version="1.0.0"
    )
    ...
    # Include routers
    fast_api.include_router(text_processor_controller_router)
