...
@singleton
class Data StoreConfig:

    def __init__(self):
        self.__logger = logging.getLogger(self.__class__.__name__)

        # Resolve config file path relative to __main__.py entry point
        # From: services/sphana-data-store-service/src/python/sphana_data_store/__main__.py
        # To:   services/sphana-data-store-service/src/resources/configs/default.yaml
