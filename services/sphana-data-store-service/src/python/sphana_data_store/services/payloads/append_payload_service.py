...
class AppendPayloadService:
    ...
    def append_payload(self, index_name: str, entry_id: str, payload: bytes):
        # Get index details
        ...
        self.__entry_payloads_repository.append(shard_name, entry_id, payload)