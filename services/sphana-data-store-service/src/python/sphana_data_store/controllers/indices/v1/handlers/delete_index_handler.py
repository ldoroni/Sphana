...
from sphana_data_store.controllers.indices.v1.schemas import DeleteIndexRequest, DeleteIndexResponse
from sphana_data_store.services.indices import DeleteIndexService
