...
from sphana_data_store.controllers.entries.v1.schemas import UpdateEntryRequest, UpdateEntryResponse
from sphana_data_store.services.entries import UpdateEntryService
