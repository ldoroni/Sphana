...
from sphana_data_store.controllers.entries.v1.schemas import DeleteEntryRequest, DeleteEntryResponse
from sphana_data_store.services.entries import DeleteEntryService
