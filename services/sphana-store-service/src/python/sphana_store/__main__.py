...
from sphana_store.controllers.chunks.v1 import router as chunks_management_controller_router
from sphana_store.controllers.entries.v1 import router as entries_management_controller_router
from sphana_store.controllers.indices.v1 import router as index_management_controller_router
from sphana_store.controllers.queries.v1 import router as query_executor_controller_router
...
def main(host='0.0.0.0', port=5001, max_threads=100, debug=False):
    ...
    fast_api: FastAPI = FastAPI(
        title="Sphana Store API",
        description="API for Sphana Store",
        version="1.0.0"
    )
