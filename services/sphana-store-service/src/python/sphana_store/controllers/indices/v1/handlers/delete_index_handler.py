...
from sphana_store.controllers.indices.v1.schemas import DeleteIndexRequest, DeleteIndexResponse
from sphana_store.services.indices import DeleteIndexService
