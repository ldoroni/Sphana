...
from sphana_store.constants import GLOBAL_SHARD_NAME
from sphana_store.configs import StoreConfig
from sphana_store.models import ListResults, ShardDetails
from sphana_store.repositories import ShardDetailsRepository
...
class ClusterNodesService:
    ...
    def get_node(self, shard_name: str) -> str:
        ...
        if len(self.store_config.nodes) == 0:
            raise ValueError("No nodes configured in Store config")
