...
class TextTokenizerService:
    ...
    def __init__(self):
        ...
        # From: services/sphana-text-processor-service/src/python/sphana_text_processor/__main__.py
        # To:   services/sphana-text-processor-service/src/resources/models/embedding
